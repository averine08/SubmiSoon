...
- Run ```cd frontend```
- Run ```npm install```, make sure npm version is 10 at max (to ensure tailwind is running)
  Note: can downgrade npm version locally by run "npm install npm@10 --save-dev" on the folder project
