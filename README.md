...
- Run "cd frontend"
- Run "npm install", make sure npm version is 10 at max (to ensure tailwind is running) | note: can downgrade npm version by run "npm install npm@10 --save-dev" on the folder project
